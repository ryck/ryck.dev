  ...
  try {
    ...
    return new ImageResponse(
      (
        ...
        >
          <div tw="rounded p-10 bg-zinc-900 h-full w-full flex flex-col pattern-diagonal-lines pattern-yellow-500 pattern-bg-zinc-900 pattern-size-32 pattern-opacity-40">
